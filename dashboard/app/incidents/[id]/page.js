...
const STATUS_ORDER = {
  ...
  PENDING_PR_MERGE: 4, VERIFIED: 5, RESOLVED: 6, FAILED: -1, ESCALATED: -2,
};
          ...
          {audit ? (
            <>
              ...
              {audit.is_shadow === 'true' && (
                <div className="status-pill shadow" style={{ marginTop: 8 }}>🛡 Shadow Run</div>
              )}
            </>
          ) : (
      ...
      {audit && (
        <div className="card mt-16">
          ...
          <p style={{ fontSize: 12, color: 'var(--text-secondary)', marginBottom: 12 }}>
            Why this action was {audit.policy_verdict?.toLowerCase() || 'evaluated'}
          </p>
          <div className="policy-grid">
            ...
            <div className="policy-gate">
              ...
              Namespace: {telemetry_context?.target_pod ? 'autofixops' : 'unknown'}
            </div>
            <div className="policy-gate">
              <span className="gate-icon">✅</span>
            ...
            <div className="policy-gate">
              ...
              Action Allowlist: {audit.action || 'N/A'}
            </div>
            <div className="policy-gate">
              <span className="gate-icon">✅</span>
              Anti-Thrashing: Pass
